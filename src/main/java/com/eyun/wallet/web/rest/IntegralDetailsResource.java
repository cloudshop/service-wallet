...
public class IntegralDetailsResource {
     ...
     * @return
     */
    @ApiOperation("获取钱包积分明细")
    @GetMapping("/wallet/details/integral")
    public ResponseEntity<List<IntegralDetailsDTO>> getWalletDetailsWithIntegral(Pageable pageable) {
    	UserDTO user = uaaService.getAccount();
    	IntegralDetailsCriteria criteria = new IntegralDetailsCriteria();
